 openerp.carrent_reservation = function(openerp) {
    var _t = openerp.web._t;
    _lt = openerp.web._lt;
    var QWeb = openerp.web.qweb;
    
    console.log("asdasdasdasdasdas");
    openerp.carrent_reservation.UnitSummary = openerp.web.form.FormWidget.extend(openerp.web.form.ReinitializeWidgetMixin, {
        ...
        init: function() {
	    	...
	    	if(this.field_manager.model == "dtbs.carrent.reservation.summary")
	    	{
        ...
        load_form: function(data) {
            ...
            this.$el.find(".table_free").bind("click", function(event){
                self.action_manager.do_action({
                        ...
                        res_model: "quick.unit.reservation",
                        views: [[false, 'form']],
                        target: 'new',
                        context: {"unit_id": $(this).attr("data"), 'date': $(this).attr("date")},
                });
            });
    ...
    openerp.web.form.custom_widgets.add('Unit_Reservation', 'openerp.carrent_reservation.UnitSummary');
};
